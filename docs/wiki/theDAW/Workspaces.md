...
Seven workspaces plus the library, the Catalogue, and the live tools. Each entry links to its full reference in the User Guide.
...
- [Notation and Score](https://github.com/gantasmo/theDAW/blob/main/docs/USER_GUIDE.md#33-notation-score-tabs-and-arrangements): one maker for sheets, guitar, bass and ukulele tabs, arrangements and chord tracks; ABC, PDF, and SVG export; and prompt inference.
...
<p align="center"><a href="Dataflow">&lt; Previous: Dataflow</a> &nbsp; | &nbsp; <a href="Models">Next: Models &gt;</a></p>
