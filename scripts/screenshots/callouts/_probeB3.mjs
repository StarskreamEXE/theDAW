...
await settle(page, 3000);
await page.screenshot({path:'../docs/guides/screenshots/callouts/raw/_probeDetails.png'});
await dump('details');
await browser.close();
