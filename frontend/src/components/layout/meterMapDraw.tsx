/**
 * The meter map, drawn: everything that turns a rhythm result into SVG.
 *
 * Kept apart from the component that shows it because a module exporting both a
 * component and plain functions cannot be hot-reloaded -- React Fast Refresh
 * gives up on it and reloads the whole page on every edit, which in this app
 * means re-mounting every store.
 *
...
import { renderSvgToString, standaloneHtml } from '../../lib/exportPicture';
